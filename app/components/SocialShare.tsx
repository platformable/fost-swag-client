    ...
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Modal panel */}
          <div className="relative bg-[#0B0F1C] border-2 border-default border-[#FC6200] rounded-base shadow-sm p-4 md:p-6  rounded-lg w-1/4">
            {/* Header */}
            <div className="flex items-center justify-between px-5 pt-5 pb-4 ">
              <h2
                id="share-modal-title"
                className="text-base font-semibold text-white dark:text-zinc-100"
              >
                Share this offer
              </h2>
              <button
                onClick={handleClose}
                className="rounded-lg p-1.5 text-zinc-400 transition-colors  dark:hover:text-zinc-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500 cursor-pointer"
                aria-label="Cerrar"
              >
                <CloseIcon />
              </button>
            ...
            <div className="px-5 py-4 grid grid-cols-5 gap-3">
              {PLATFORMS.map((platform) => (
                <button
                  ...
                  className={`flex flex-col items-center gap-1.5 rounded-xl p-2.5 text-white transition-all duration-150 active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 ${platform.color} ${platform.hoverColor}`}
                >
                  {platform.icon}
            ...
            <div className="px-5 pb-5">
              ...
              <div className="flex items-center gap-2 rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2 dark:border-zinc-700 dark:bg-zinc-800">
                ...
                <button
                  onClick={handleCopy}
                  className={`flex-shrink-0 flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-semibold transition-all duration-150 active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500 ${
                    copied
